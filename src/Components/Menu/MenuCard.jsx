            ...
            {data.length > 0 ? (
                <div className="Menu__Wrapper mt-[50px] grid gap-4">
                    {data.map((i, index) => (
                        ...
                        >
                            <div className="w-full py-[5px] bg-white text-[#026634] rounded-t-[10px] h-[30px] text-center">
                ...
                <div className="flex items-center justify-center h-[50vh]">
                    <p className="text-white text-2xl font-semibold opacity-80">Ma'lumot yo'q</p>
                </div>
            )}
            {loading && hasMore && (
